...
public class MultipleMunicipalitySelectionSpinner extends AppCompatSpinner implements
    ...
    public MultipleMunicipalitySelectionSpinner(Context context) {
        super(context);
    ...
    public MultipleMunicipalitySelectionSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
